...
})({"ccMq2":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "d00b99625c83be0a";
"use strict";
...
var _selectOrder = require("./selectOrder");
...
function initQuiz(options_ = {}) {
    ...
    (0, _jqueryDefault.default)(progressBar).attr("value", 0);
    (0, _jqueryDefault.default)(progressBar).attr("max", questions.length);
    (0, _jqueryDefault.default)(questionText.value).text(1);
    (0, _jqueryDefault.default)(questionText.max).text(questions.length);
    var questionData = [];
    for(let i = 0; i < questions.length; i++){
        const sh = (0, _helperJs.shuffle)(questions[i].images);
        questionData.push(new Question(questions[i].title, sh, questions[i].orderData));
    }
    (0, _jqueryDefault.default)(nextButton).on("click", ()=>{
        const qIndx = (0, _jqueryDefault.default)(manager).data("currQuestion");
        if (qIndx + 1 >= questions.length) {
            if ((0, _jqueryDefault.default)(nextButton).hasClass("btn-success")) (0, _sweetalert2Default.default).fire({
                ...
                if (result.isConfirmed) {
                    ...
                    questions.forEach((q, i)=>{
                        if (!questionData[i].orderData) resultArr.push(false);
        ...
        (0, _jqueryDefault.default)(manager).data("currQuestion", qIndx + 1);
        (0, _jqueryDefault.default)(questionText.value).text(qIndx + 2);
        (0, _jqueryDefault.default)(progressBar).attr("value", qIndx + 1);
    ...
    (0, _jqueryDefault.default)(prevButton).on("click", ()=>{
        const qIndx = (0, _jqueryDefault.default)(manager).data("currQuestion");
        if (qIndx <= 0) return;
        (0, _jqueryDefault.default)(manager).data("currQuestion", qIndx - 1);
        (0, _jqueryDefault.default)(questionText.value).text(qIndx);
        (0, _jqueryDefault.default)(progressBar).attr("value", qIndx - 1);
        loadQuestion(questionData[qIndx - 1], manager, orderItem, (orderData)=>{
            questionData[qIndx - 1].orderData = orderData;
        });
    ...
    (0, _jqueryDefault.default)(manager).data("currQuestion", 0);
...
function checkFinishState(manager, questions, nextButton) {
    if ((0, _jqueryDefault.default)(manager).data("currQuestion") + 1 >= questions.length) (0, _jqueryDefault.default)(nextButton).removeClass("btn-primary").addClass("btn-success").text("Bitir");
    else (0, _jqueryDefault.default)(nextButton).removeClass("btn-success").addClass("btn-primary").text("Sonraki");
}
function loadQuestion(question, manager, orderItem, orderChangedCallback) {
    (0, _jqueryDefault.default)(manager).empty();
    (0, _jqueryDefault.default)("#text-q").text(question.title);
    question.images.forEach((img, i)=>{
        injectImage(img, manager, i);
    });
    if (question.orderData) (0, _jqueryDefault.default)(manager).data("orders", question.orderData);
    (0, _selectOrder.initOrder)(manager, orderItem, !question.orderData, (orderData)=>{
...
function injectImage(src, manager, id) {
    ...
    (0, _jqueryDefault.default)(manager).append(html);
}
function getSrcs(questionImageCount, orderData) {
    var srcs = [];
    if (orderData.length < questionImageCount) return null;
    orderData.forEach((e)=>{
        srcs.push((0, _jqueryDefault.default)(e).children("img").attr("src"));
    });
    return srcs;
}
...
},{"jquery":"hgMhh","../helper.js":"3GF3D","./selectOrder":"1mzg5","sweetalert2":"1HyFr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{}],"1mzg5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
function initOrder(manager, orderItem, resetManager_ = true, orderChangedCallback) {
    if (resetManager_) resetManager(manager);
    else syncManagerOrders(manager, orderItem);
    (0, _jqueryDefault.default)(manager).children(orderItem).each((_i, e)=>{
        (0, _jqueryDefault.default)(e).on("click", ()=>{
...
function getOrder(manager) {
    return (0, _jqueryDefault.default)(manager).data("orders");
}
function syncData(e) {
    if ((0, _jqueryDefault.default)(e).data("ordered") && (0, _jqueryDefault.default)(e).data("order")) {
        (0, _jqueryDefault.default)(e).children(".image-order").addClass("ordered");
        (0, _jqueryDefault.default)(e).children(".image-order").text((0, _jqueryDefault.default)(e).data("order"));
    } else {
        (0, _jqueryDefault.default)(e).children(".image-order").removeClass("ordered");
        (0, _jqueryDefault.default)(e).children(".image-order").text("");
    }
}
function handleClick(e, manager, orderItem) {
    if (getOrder(manager).length >= (0, _jqueryDefault.default)(manager).children(orderItem).length) return resetOrder(manager);
        ...
        if (index > -1) {
            ...
            (0, _jqueryDefault.default)(e).data("ordered", false);
            (0, _jqueryDefault.default)(e).data("order", -1);
            //check if there is selected items with a bigger
            //index than the one being deselected right now.
            (0, _jqueryDefault.default)(manager).children(orderItem).each((i, item)=>{
                if (!(0, _jqueryDefault.default)(item).data("ordered")) return;
                const itemOrder = (0, _jqueryDefault.default)(item).data("order");
                if (itemOrder > index) {
                    (0, _jqueryDefault.default)(item).data("order", itemOrder - 1);
                    syncData(item);
                }
            });
    ...
    orders.push(e);
    (0, _jqueryDefault.default)(manager).data("orders", orders);
    (0, _jqueryDefault.default)(e).data("ordered", true);
    (0, _jqueryDefault.default)(e).data("order", currIndx);
    //move selected item to its nth place
    return;
}
function syncManagerOrders(manager, orderItem) {
    const orders = getOrder(manager);
    (0, _jqueryDefault.default)(manager).data("orderIndx", orders.length);
    orders.forEach((e, i)=>{
        (0, _jqueryDefault.default)(manager).children(`[data-id=${(0, _jqueryDefault.default)(e).attr("data-id")}]`).replaceWith(e);
        return;
    });
}
function resetOrder(manager) {
    (0, _jqueryDefault.default)(manager).children().each((i, e)=>{
        (0, _jqueryDefault.default)(e).data("ordered", false);
        (0, _jqueryDefault.default)(e).data("order", -1);
        syncData(e);
    });
...
function resetManager(manager) {
    (0, _jqueryDefault.default)(manager).data("orderIndx", 0);
    (0, _jqueryDefault.default)(manager).data("orders", []);
}

},{"jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1HyFr":[function(require,module,exports) {
/*!
...
},{}],"egP2y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
//# sourceMappingURL=index.5c83be0a.js.map
